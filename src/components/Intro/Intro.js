  ...
  return (
    <>
      <Container fluid className="intro_top text-center pt-4 pb-md-4 pb-4 m-0">
        <Row className="m-0">
          <Col className="m-0 ">
            <div className="w-100 d-flex justify-content-center flex-md-row flex-column align-items-center align-content-center">
              <h1>
              ...
              <a
                ...
                target={"_self"}
                rel="noreferrer"
                className="btn-blue-destacado btnPortadaIntro  ps-5 pe-5 ms-md-4 ms-0 mt-md-0 mt-4"
